...
<div id="main" role="main">
    ...
    <div class="col-md-10 col-lg-offset-1 form-row">
        <a class="btn btn-primary btn-lg" href="{{ action('LocationController@getCreate') }}?field_id={{ $id }}">
    ...
    $(document).ready(function() {
        ...
        var oTable = $('#fields').DataTable({
            ...
            "columns": [
                ...
                {data: "injection_count", orderable: true, searchable: false},
