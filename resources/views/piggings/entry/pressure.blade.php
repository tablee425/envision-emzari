...
<div id="main" role="main">
    ...
    <div>
        ...
        <div class="widget-body no-padding">
            <form id="pressure-form" class="smart-form" method="POST" action="{{ action('PigRunController@update', [$pigging]) }}" novalidate="novalidate">
                {{ csrf_field() }}
...
$(function() {
    ...
    // $('#pressure-form').on('submit', function(e) {
    //     var $form = $(this);
        
    //     if($('input[name=cancelled_on]').val())
    //     {
    //         e.preventDefault();
