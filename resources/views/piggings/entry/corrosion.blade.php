...
<div id="main" role="main">
    ...
    <div>
        ...
        <div class="widget-body no-padding">
            <form id="corrosion-form" class="smart-form" method="POST" action="{{ action('PigRunController@update', [$pigging]) }}" novalidate="novalidate">
                {{ csrf_field() }}
                ...
                <fieldset> 
                    ...
                    <div class="row">
                        <section class="col col-2">
                            ...
                            <label class="input"> <i class="icon-prepend fa fa-briefcase"></i>
                                <input  type="text" name="corr_inh_vol" placeholder="Corr Inh Vol" @if($pigging->corr_inh_vol) value="{{ old('corr_inh_vol') ?: $pigging->corr_inh_vol }}" @elseif ($corrosion && $corrosion['corr_inh_vol']) value="{{ old('corr_inh_vol') ?: $corrosion['corr_inh_vol'] }}" @endif>
                            </label>
                        </section>
                        <section class="col col-2">
                            <label class="label">Biocide Vol</label>
                            <label class="input"> <i class="icon-prepend fa fa-briefcase"></i>
                                <input  type="text" name="biocide_vol" placeholder="Biocide Vol" @if($pigging->biocide_vol) value="{{ old('biocide_vol') ?: $pigging->biocide_vol }}" @elseif ($corrosion && $corrosion['biocide_vol']) value="{{ old('biocide_vol') ?: $corrosion['biocide_vol'] }}" @endif>
                            </label>
                        </section>
                        <section class="col col-2">
                            <label class="label">Diluent</label>
                            <label class="input"> <i class="icon-prepend fa fa-briefcase"></i>
                                <input  type="text" name="diluent" placeholder="Diluent" @if($pigging->diluent) value="{{ old('diluent') ?: $pigging->diluent }}" @elseif ($corrosion && $corrosion['diluent']) value="{{ old('diluent') ?: $corrosion['diluent'] }}" @endif>
                            </label>
                        </section>
                    </div>
                    <div class="row">
...
$(function() {
    ...
    // $('#corrosion-form').on('submit', function(e) {
    //     var $form = $(this);
