...
<div id="main" role="main">
    ...
    <div class="col-md-12 form-row">
        <a href="{{ action('AnalysisController@getCreate', $location_id) }}" class="btn btn-info">+ Add New Analysis</a>
    </div>

    <div class="col-lg-10 col-lg-offset-1" style="margin-bottom: 80px;">
        <table id="analysis" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
            <thead>
                <tr>
                    <th>ID</th>
                    <th>Location</th>
                    <th>Location Desc</th>
                    <th>Date</th>
                    <th>Corrosion Residuals</th>
                    <th>Scale Residuals</th>
                    <th>Water Qualities</th>
                    <th>Comments</th>
                    <th>Files</th>
                    <th>Action</th>
                </tr>
            ...
            <tfoot>
                <tr>
                    ...
                    <td data-search="Corrosion Residuals"></td>
                    <td data-search="Scale Residuals"></td>
                    <td data-search="Water Qualities"></td>
...
<script>
    $(document).ready(function() {
        ...
        $('#analysis tfoot td').each( function (el) {
            var title = $('#analysis tfoot td').eq( el ).data('search');
            $(this).html( '<input type="text" placeholder="Search '+title+'" tabindex="'+ el +'"/>' );
        } );

        var oTable = $('#analysis').DataTable({
            "processing" : true,
            "serverSide" : true,
            "ajax" : { 'url' : "/analysis/data",
                       'type' : 'POST',
            ...
            "columns": [
                ...
                {data: "corrosion_residuals", name: "corrosion_residuals", width: "60px", orderable: true, searchable: true, className: 'editable'},
                {data: "scale_residuals", name: "scale_residuals", width: "60px", orderable: true, searchable: true, className: 'editable'},
                {data: "water_qualities", name: "water_qualities", width: "60px", orderable: true, searchable: true, className: 'editable'},
